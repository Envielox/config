...
hi Pmenu      ctermbg=Magenta guibg=LightBlue
hi PmenuSel   ctermfg=White	   ctermbg=LightBlue  guifg=White  guibg=DarkBlue
...
hi Special    cterm=NONE ctermfg=DarkMagenta    gui=NONE guifg=#ff1493 guibg=#ffe4e1
hi Conceal    cterm=NONE ctermfg=93 ctermbg=NONE          gui=NONE guifg=#8700ff guibg=NONE
